                ...
                >
                    <CardHeader className="p-4 flex-row items-start justify-between gap-2">
                        <div className="flex-grow overflow-hidden">
                            <CardTitle className="text-base font-semibold mb-1 break-words line-clamp-1">
                                {note.title}
                            </CardTitle>
                            ...
                            {note.attachments && note.attachments.length > 0 && (
                                <Badge
                                    variant="secondary"
                                    className="text-[10px] px-1.5 py-0 pointer-events-none mt-2"
                                >
